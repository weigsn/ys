...
var rule = {
    ...
    headers:{
        ...
        "Cookie":"SESSDATA=8a342237%2C1717720914%2Cad152%2Ac1CjAI7lFDbr9Wlb6WWq1gwWKrFSGHnqgFdC4gO3x6gzdxxDrCLzUwuAIPQQC6-3jY-cUSVlNDeE9rZTVjLWVPUDFRUlBBR3BuN0FhaWFIRGYxZTJqeTdsT2E1Zi1sUHM4b1VJMXdrWVprcFhtVmdNMDRiNmd4TEMxNVNEMHhuYWtlbVBESnd5aF93IIEC; bili_jct=81665ed688f163a82c181774dc069294; DedeUserID=29803158; DedeUserID__ckMd5=1a97fc9755184b19; sid=7dy2gka0"
    },
    timeout:5000,
    limit:8,
    play_parse:true,
    ...
    一级:`js:
        ...
        if (MY_CATE === '推荐') {
            ...
            input = HOST + '/x/space/wbi/arc/search?mid=' + cateObj.tid + '&pn=' + MY_PAGE;
            data = JSON.parse(request(input)).data;
            vodList = data.list.vlist;
        }else {
            data = JSON.parse(request(input)).data;
            vodList = data.result;
        }
        ...
        vodList.forEach(function(vod) {
            ...
            if (MY_CATE === '推荐') {
                ...
                remark = turnDHM(vod.duration) + ' ▶' + play + ' 💬' + danmaku;
            } else if (MY_CATE === '历史记录') {
                play = ConvertNum(vod.stat.view);
                danmaku = vod.stat.danmaku;
                remark = turnDHM(vod.duration) + ' ▶' + play + ' 💬' + danmaku;
    ...
    二级:`js:
        ...
        let vod = {
            ...
            vod_director: '🆙 ' + '[a=cr:' + JSON.stringify({'id':up_mid + '_clicklink','name':up_name}) + '/]' + up_name + '[/a]' + '　👥 ' + up_info.follower + '　' + relation,
