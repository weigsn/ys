...
class Spider(Spider):
    ...
    defaultConfig = {
        ...
        'raw_cookie_line': "buvid3=5A7DF58C-14D6-23C1-BE29-31D9E9578C2997581infoc; b_nut=1683970697; CURRENT_FNVAL=4048; _uuid=F6EC89FA-83F6-2531-D341-349E26395CC798083infoc; buvid4=C77042B4-6C2D-C24A-0F86-E0A4B7E253A698377-023051317-ztKcD%2BAh2fSUh5SCSJ6FIQ%3D%3D; rpdid=|(YYR|mmYJ~0J'uY)Jm~|~||; i-wanna-go-back=-1; FEED_LIVE_VERSION=V8; header_theme_version=CLOSE; b_ut=5; buvid_fp_plain=undefined; CURRENT_QUALITY=80; hit-new-style-dyn=1; hit-dyn-v2=1; LIVE_BUVID=AUTO5016839809229220; home_feed_column=5; fingerprint=49d611e6002bd1170902c2a0be89af54; buvid_fp=ffd4d72041819ec06604c3a45724a51f; is-2022-channel=1; enable_web_push=DISABLE; browser_resolution=1872-924; DedeUserID=29803158; DedeUserID__ckMd5=1a97fc9755184b19; PVID=1; SESSDATA=d9a8ab5a%2C1719311686%2C96d57%2Ac2CjBZK9eturrHRYLAtDlP5nid9wHsEZ6l09h9xCcWuOjatPLuWHCXEnAqtgW6B50KyakSVnBRekRISXhKaE9rYlUzTXZOaldpQ0hyZW5zanlxeWZhLXV5ejRjZEF1Q0EzVlJmMjlZSkRuZkhCZXBMSFY1NVhEb25Tb1VPYy1WS3BrdGtERjhBMFhnIIEC; bili_jct=047b3d47cb3b896e87825d1105715b11; bili_ticket=eyJhbGciOiJIUzI1NiIsImtpZCI6InMwMyIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MDQwMTg5MDcsImlhdCI6MTcwMzc1OTY0NywicGx0IjotMX0.Zx13hVuUe8SlnD4BGe5gX4AiyqISQUC15FP26uzKeyo; bili_ticket_expires=1704018847; bp_video_offset_29803158=880128757048803351; b_lsid=48D106B1010_18CBE95C47D; bmg_af_switch=1; bmg_src_def_domain=i1.hdslb.com; sid=7bkgk2p9",
    ...
    get_up_videoss_result = {}
    def get_up_videoss(self, mid, pg):
        result = {}
        url = 'https://api.bilibili.com/x/space/wbi/arc/search?mid={0}&pn={1}'.format(mid,pg)
        rsp = self._get_sth(url, 'fake')
        content = rsp.text
        jo = json.loads(content)
        videos = []
    ...
    def homeVideoContent(self):
        if not self.homeVideoContent_result:
            videos = self.get_found(rid='0', tid='推荐', pg=1)['list'][0:int(self.userConfig['maxHomeVideoContent'])]
    ...
    def detailContent(self, array):
        ...
        #vod['vod_director'] = '🆙 ' + '[a=cr:' + str({'id':up_mid,'name':up_name}) + '/]' + up_name + '[/a]'  + '　👥 ' + self.up_info[up_mid]['fans'] + '　' + '　'.join(relation.result())
